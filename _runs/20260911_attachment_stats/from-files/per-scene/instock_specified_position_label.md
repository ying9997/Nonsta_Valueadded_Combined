...
| VAS_ATTR_REL_LF | 标签文件 | 100.0% (7/7) | 71.4% (5/7) | 必填 |
| VAS_ATTR_REL_AOOI | 操作说明附件 | 100.0% (7/7) | 42.9% (3/7) | 可选 |
...
| VAS_ATTR_REL_TCRBCAL | 商品和标签的对应关系 | 100.0% (7/7) | 14.3% (1/7) | 可选 |
...
- 建议可选：VAS_ATTR_REL_AOOI, VAS_ATTR_REL_NWEON, OONFRFTS, NSVASTN, VAS_ATTR_REL_TCRBCAL
