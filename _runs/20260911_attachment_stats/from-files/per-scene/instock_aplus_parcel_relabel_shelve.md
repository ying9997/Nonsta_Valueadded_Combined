...
| VAS_ATTR_REL_LF | 标签文件 | 100.0% (7/7) | 100.0% (7/7) | 必填 |
...
| BTBATSPASTC | 买卖双方提供并签署合约 | 14.3% (1/7) | 14.3% (1/7) | 不列入 |
## 建议必填 / 可选
- 建议必填：VAS_ATTR_REL_NWEON, VAS_ATTR_REL_LF
- 建议可选：VAS_ATTR_REL_TCRBCAL, PACKAGE_SERNO, MERCHANDISE_SERNO, OONFRFTS, VAS_ATTR_REL_VOIC
