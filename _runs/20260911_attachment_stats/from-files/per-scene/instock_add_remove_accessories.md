...
| VAS_ATTR_REL_AOOI | 操作说明附件 | 100.0% (22/22) | 59.1% (13/22) | 必填 |
| VAS_ATTR_REL_LF | 标签文件 | 100.0% (22/22) | 59.1% (13/22) | 必填 |
| VSS | 视频拍摄SOP（中文+英文） | 100.0% (22/22) | 27.3% (6/22) | 可选 |
| MERCHANDISE_SERNO | 商品条码 | 100.0% (22/22) | 18.2% (4/22) | 可选 |
| PACKAGE_SERNO | 包裹条码 | 100.0% (22/22) | 13.6% (3/22) | 可选 |
| VAS_ATTR_REL_TCRBCAL | 商品和标签的对应关系 | 100.0% (22/22) | 13.6% (3/22) | 可选 |
| NSVASTN | 非标增值来源单号 | 100.0% (22/22) | 9.1% (2/22) | 不列入 |
| CEO_SOA | CEO审批截图 | 100.0% (22/22) | 4.5% (1/22) | 不列入 |
| VAS_ATTR_REL_VOIC | 增值单品数量 | 13.6% (3/22) | 13.6% (3/22) | 不列入 |
| VAS_ATTR_REL_VACQ | 增值商品数量 | 13.6% (3/22) | 13.6% (3/22) | 不列入 |
| VAS_ATTR_REL_RDP | 结果展示照片 | 13.6% (3/22) | 9.1% (2/22) | 不列入 |
| VAS_ATTR_REL_EOR | 结果说明 | 13.6% (3/22) | 0.0% (0/22) | 不列入 |
## 建议必填 / 可选
- 建议必填：VAS_ATTR_REL_NWEON, OONFRFTS, VAS_ATTR_REL_AOOI, VAS_ATTR_REL_LF
- 建议可选：VSS, MERCHANDISE_SERNO, PACKAGE_SERNO, VAS_ATTR_REL_TCRBCAL
- 可写入 requiredFieldKeys（pipeline 能校验）：VAS_ATTR_REL_NWEON, VAS_ATTR_REL_AOOI, VAS_ATTR_REL_LF
