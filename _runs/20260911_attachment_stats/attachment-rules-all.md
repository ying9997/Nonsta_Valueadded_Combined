...
- 数据源：`D:\DA\Nonsta_Valueadded_Combined\_runs\20260909_inbound_scene_probe\_oms_cache/attrs_submit.csv + atoms.csv`
- 只统计 `inputNode=SUBMIT`
- 判断规则：出现率 ≥ 70% **且** 非空率 ≥ 50% → 建议必填；出现率 ≥ 30% 且非空率 ≥ 10%（但未达必填）→ 建议可选；空表单槽（有 key 无值）不列入
- 场景订单数 < 5 → 待验证，不自动填
- 出现率 = 有该 key 的订单数 / 该场景总订单数；非空率 = attributeValue 非空的订单数 / 总数
- **附件槽位注意：** `VAS_ATTR_REL_LF` / `AOOI` / `TCRBCAL` / `TRPP` / `VSS` / `CEO_SOA` 在本 CSV 里经常是空值（文件在 `vaAtomFiles`，不在 attributeValue）。所以附件很难靠非空率达 50%。建议必填目前主要是有填写值的字段（尤其 `VAS_ATTR_REL_NWEON` 上架入库单号）。
- `BEOR` / `VAS_ATTR_REL_RD` 是需求正文，不算附件门。
- 有 OMS 码场景：44；其中建议必填 ≥1 项：25；无码：31

## 汇总

| # | 场景名 | omsSceneCode | 订单数 | 建议必填 | 建议可选 | 待验证 |
|---|--------|-------------|-------|---------|---------|--------|
| 1 | 【库内】辨识拍照后销毁 | 20250407045 | 13 |  | VAS_ATTR_REL_NWEON, MERCHANDISE_SERNO |  |
| 2 | 【库内】不良品转良品 | 20250808002 | 3 |  |  | n=3<5 |
| 3 | 【库内】拆分SKU | INSTOCK_SPLIT_SKU | 34 | VAS_ATTR_REL_NWEON | OONFRFTS, VAS_ATTR_REL_QOSIITOAS, VAS_ATTR_REL_NPB |  |
| 4 | 【库内】代采购包材物料 | 20250619001 | 29 | VAS_ATTR_REL_NOPM, VAS_ATTR_REL_QOPM, VAS_ATTR_REL_DOPM, POML |  |  |
| 5 | 【库内】非标收费 | 20250620001 | 52 | VAS_ATTR_REL_VOIC |  |  |
| 6 | 【库内】更换客制包装 | 20250407055 | 9 | VAS_ATTR_REL_NWEON, OONFRFTS | PACKAGE_SERNO, MERCHANDISE_SERNO, NSVASTN |  |
| 7 | 【库内】更换商品生产日期标签 | 20260108001 | 0 |  |  | 缓存无单 |
| 8 | 【库内】货权转移-改数 | 【In-warehouse】Transfer of ownership of goods | 44 | VAS_ATTR_REL_VOIC | OONFRFTS, VAS_ATTR_REL_NWEON |  |
| 9 | 【库内】货权转移（换标模式） | 【In-warehouse】Transfer of ownership of goods | 44 | VAS_ATTR_REL_VOIC | OONFRFTS, VAS_ATTR_REL_NWEON |  |
| 10 | 【库内】库存冻结/解冻 | INSTOCK_INVENTORY_FREEZE_UNFREEZE | 13 |  | MERCHANDISE_SERNO |  |
| 11 | 【库内】库内仓间调拨 | 20250407074 | 5 |  | VAS_ATTR_REL_NWEON, OONFRFTS |  |
| 12 | 【库内】库内加固 | 20250407056 | 6 |  | VAS_ATTR_REL_NWEON, MERCHANDISE_SERNO, VAS_ATTR_REL_VOIC, VAS_ATTR_REL_VACQ |  |
| 13 | 【库内】良品/不良品检测 | 20250407051 | 14 |  |  |  |
| 14 | 【库内】良品转不良品上架 | 20250808003 | 16 |  | VAS_ATTR_REL_NWEON, OONFRFTS, VAS_ATTR_REL_VOIC, VAS_ATTR_REL_VACQ |  |
| 15 | 【库内】拍摄照片/视频 | 20250407035 | 54 |  | MERCHANDISE_SERNO, PACKAGE_SERNO, VAS_ATTR_REL_NWEON |  |
| 16 | 【库内】商品拆箱加/减配件 | 20250421001 | 22 | VAS_ATTR_REL_NWEON, OONFRFTS | MERCHANDISE_SERNO, PACKAGE_SERNO |  |
| 17 | 【库内】商品尺重测量辨识 | 【Warehouse】Measurement and identification of commodity weight | 15 |  | MERCHANDISE_SERNO |  |
| 18 | 【库内】商品贴指令性标签（警示标语/使用说明/清洁维护等）+拍照 | 20250427001 | 2 |  |  | n=2<5 |
| 19 | 【库内】商品外观辨识+贴标上架 | 20250407043 | 62 | VAS_ATTR_REL_NWEON | OONFRFTS, MERCHANDISE_SERNO |  |
| 20 | 【库内】商品组合 | 20250407071 | 28 | VAS_ATTR_REL_NWEON, OONFRFTS | MERCHANDISE_SERNO |  |
| 21 | 【库内】审计盘点 | 20250407039 | 40 | MERCHANDISE_SERNO, VAS_ATTR_REL_WWH |  |  |
| 22 | 【库内】异常商品转不良品上架 | 202512150002 | 22 | VAS_ATTR_REL_NWEON | NSVASTN |  |
| 23 | 【库内】异常重新拍照 | 【Library】Abnormal re-photographing | 10 |  | PACKAGE_SERNO, NSVASTN |  |
| 24 | 【库内】指定单品/库位商品更换标签上架【换标前后SKU不一样】 | 20250407062 | 49 | VAS_ATTR_REL_NWEON, OONFRFTS | MERCHANDISE_SERNO, PACKAGE_SERNO |  |
| 25 | 【库内】指定位置贴标 | 20260127001 | 7 |  | VAS_ATTR_REL_NWEON, OONFRFTS, NSVASTN |  |
| 26 | 【库内】A+包裹更换标签上架 | 20250407060 | 7 | VAS_ATTR_REL_NWEON | PACKAGE_SERNO, MERCHANDISE_SERNO, OONFRFTS, VAS_ATTR_REL_VOIC |  |
| 27 | 【入库】“包裹条码批量异常（需客户处理）”辨识后补贴包裹标签上架 | 20250430 | 76 | VAS_ATTR_REL_NWEON | NSVASTN |  |
| 28 | 【入库】包裹串仓异常调拨 | [Warehouse]AbnormalTransferOfParcelsFromMultipleWarehouses | 9 |  | VAS_ATTR_REL_NWEON, PACKAGE_SERNO, MERCHANDISE_SERNO, NSVASTN, TJ, VAS_ATTR_REL_VPC, VAS_ATTR_REL_AT, DW |  |
| 29 | 【入库】包裹类异常换商品标签上架 | 20250407008 | 15 | VAS_ATTR_REL_NWEON | PACKAGE_SERNO, MERCHANDISE_SERNO |  |
| 30 | 【入库】补贴透明标签 | 2026041701 | 13 | VAS_ATTR_REL_NWEON | PACKAGE_SERNO, MERCHANDISE_SERNO |  |
| 31 | 【入库】拆包/拆箱上架 | 20250407003 | 18 | VAS_ATTR_REL_NWEON |  |  |
| 32 | 【入库】尺重/标签辨识后换标上架 | 20250407004 | 37 | VAS_ATTR_REL_NWEON |  |  |
| 33 | 【入库】更换客制包材 | 20250509 | 4 |  |  | n=4<5 |
| 34 | 【入库】关联第三方商品条码上架 | 202506120001 | 42 | VAS_ATTR_REL_NWEON |  |  |
| 35 | 【入库】海运整柜100%A+无包裹条码异常，新单无箱单或100%A+包直接上架 | 20250929 | 29 | VAS_ATTR_REL_NWEON |  |  |
| 36 | 【入库】批量辨识商品后补贴商品条码及包裹条码上架 | 202506120003 | 47 | VAS_ATTR_REL_NWEON | PACKAGE_SERNO, MERCHANDISE_SERNO |  |
| 37 | 【入库】清除标签 | 20260302 | 68 | VAS_ATTR_REL_NWEON |  |  |
| 38 | 【入库】商品质检 | 20250408002 | 0 |  |  | 缓存无单 |
| 39 | 【入库】上架前盘点-辨识费 | 202506120002 | 4 |  |  | n=4<5 |
| 40 | 【入库】上架前销毁 | INBOUND_DESTORY_BF_SHELVE | 7 | VAS_ATTR_REL_NWEON | PACKAGE_SERNO, MERCHANDISE_SERNO |  |
| 41 | 【入库】上架前自提 | INBOUND_PICKUP_BF_SHELVE | 7 |  | PACKAGE_SERNO, MERCHANDISE_SERNO, VAS_ATTR_REL_NWEON, NSVASTN |  |
| 42 | 【入库】收集SN码 | 20250529001 | 7 | VAS_ATTR_REL_NWEON | PACKAGE_SERNO, MERCHANDISE_SERNO, NSVASTN |  |
| 43 | 【入库】指定商品拍照暂存 | 20250522001 | 61 |  | PACKAGE_SERNO, VAS_ATTR_REL_NWEON, MERCHANDISE_SERNO, NSVASTN |  |
| 44 | 【入库】组合后上架 | 20250407020 | 26 | VAS_ATTR_REL_NWEON |  |  |
...
- 差异：统计多出 `VAS_ATTR_REL_NWEON`；卡上多出 `VAS_ATTR_REL_LF`。**不覆盖旧卡。**
  ...
  - VAS_ATTR_REL_LF（标签文件）出现率 100.0% / 非空率 0.0% → skip
...
- 差异：统计多出 `VAS_ATTR_REL_NWEON`；卡上多出 `无`。**不覆盖旧卡。**
  ...
  - VSS（视频拍摄SOP（中文+英文））出现率 100.0% / 非空率 0.0% → skip
  - VAS_ATTR_REL_LF（标签文件）出现率 100.0% / 非空率 0.0% → skip
  - TRPP（包裹和标签的对应关系）出现率 97.6% / 非空率 0.0% → skip
