# 附件统计：【库内】货权转移（换标模式）
- sceneKey：`instock_ownership_transfer_relabel`
...
| BTBATSPASTC | 买卖双方提供并签署合约 | 97.7% (43/44) | 0.0% (0/44) | 不列入 |
| VAS_ATTR_REL_TCRBCAL | 商品和标签的对应关系 | 38.6% (17/44) | 0.0% (0/44) | 不列入 |
| OONFRFTS | 下架出库单号 | 36.4% (16/44) | 36.4% (16/44) | 可选 |
| VAS_ATTR_REL_NWEON | 上架入库单号 | 36.4% (16/44) | 36.4% (16/44) | 可选 |
| VAS_ATTR_REL_LF | 标签文件 | 36.4% (16/44) | 0.0% (0/44) | 不列入 |
