...
| VAS_ATTR_REL_AOOI | 操作说明附件 | 100.0% (47/47) | 0.0% (0/47) | 不列入 |
| CEO_SOA | CEO审批截图 | 100.0% (47/47) | 0.0% (0/47) | 不列入 |
| VAS_ATTR_REL_TCRBCAL | 商品和标签的对应关系 | 100.0% (47/47) | 0.0% (0/47) | 不列入 |
| TRPP | 包裹和标签的对应关系 | 100.0% (47/47) | 0.0% (0/47) | 不列入 |
| VSS | 视频拍摄SOP（中文+英文） | 100.0% (47/47) | 0.0% (0/47) | 不列入 |
| VAS_ATTR_REL_LF | 标签文件 | 100.0% (47/47) | 0.0% (0/47) | 不列入 |
## 建议必填 / 可选
