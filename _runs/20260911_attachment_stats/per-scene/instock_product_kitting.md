...
| VAS_ATTR_REL_AOOI | 操作说明附件 | 96.4% (27/28) | 0.0% (0/28) | 不列入 |
| CEO_SOA | CEO审批截图 | 96.4% (27/28) | 0.0% (0/28) | 不列入 |
| VSS | 视频拍摄SOP（中文+英文） | 96.4% (27/28) | 0.0% (0/28) | 不列入 |
| VAS_ATTR_REL_LF | 标签文件 | 96.4% (27/28) | 0.0% (0/28) | 不列入 |
| VAS_ATTR_REL_TCRBCAL | 商品和标签的对应关系 | 96.4% (27/28) | 0.0% (0/28) | 不列入 |
| VAS_ATTR_REL_QOSIITOAS | 拆分后订单单品数量 | 3.6% (1/28) | 3.6% (1/28) | 不列入 |
| VAS_ATTR_REL_NPB | 新商品条码 | 3.6% (1/28) | 3.6% (1/28) | 不列入 |
| VAS_ATTR_REL_SP | 示例图片 | 3.6% (1/28) | 0.0% (0/28) | 不列入 |
| TRMS | 商品拆分对应关系 | 3.6% (1/28) | 0.0% (0/28) | 不列入 |
## 建议必填 / 可选
