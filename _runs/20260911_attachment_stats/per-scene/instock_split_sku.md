...
| VAS_ATTR_REL_AOOI | 操作说明附件 | 64.7% (22/34) | 0.0% (0/34) | 不列入 |
| CEO_SOA | CEO审批截图 | 64.7% (22/34) | 0.0% (0/34) | 不列入 |
| VSS | 视频拍摄SOP（中文+英文） | 64.7% (22/34) | 0.0% (0/34) | 不列入 |
| VAS_ATTR_REL_LF | 标签文件 | 64.7% (22/34) | 0.0% (0/34) | 不列入 |
| VAS_ATTR_REL_TCRBCAL | 商品和标签的对应关系 | 64.7% (22/34) | 0.0% (0/34) | 不列入 |
...
| VAS_ATTR_REL_SP | 示例图片 | 35.3% (12/34) | 0.0% (0/34) | 不列入 |
| TRMS | 商品拆分对应关系 | 35.3% (12/34) | 0.0% (0/34) | 不列入 |
...
- 建议可选：OONFRFTS, VAS_ATTR_REL_QOSIITOAS, VAS_ATTR_REL_NPB
