---
title: oms.unusualEventOrder.queryEventOrderDetail — 查询异常事件单详情
type: reference
entity_type: interface_reference
tags: [interface-reference, value-added-service, reference]
source_refs: ["source-references/interface-documents/oms-unusual-event-order-query-event-order-detail-api.md"]
updated: 2026-06-22
confidence: medium
fidelity: preserve
status: active
