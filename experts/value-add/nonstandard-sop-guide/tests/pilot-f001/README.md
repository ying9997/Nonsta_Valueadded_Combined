...
- 字段口径：[`2.1-inbound-relabel-shelving.md`](../../../../workspace/knowledge/sop/2.1-inbound-relabel-shelving.md)
  ...
  - **必填子集**：见 [`agent-inventory-assist/03_evaluation/F-001-SIMULATED-BUSINESS-RULES.md`](../../../../../agent-inventory-assist/03_evaluation/F-001-SIMULATED-BUSINESS-RULES.md)（**模拟**，待业务覆盖）
